...
const storage = new Storage({
    projectId: "delivery-mysql-57513",
    keyFilename: './serviceAccountKey.json'
});

const bucket = storage.bucket("gs://delivery-mysql-57513.appspot.com/");

/**
 * Subir o arquivo a Firebase Storage
 * @param {File} file objeto que sera armazenado em Firebase Storage
 */
        ...
        if (deletePathImage) {
            ...
            if (deletePathImage != null || deletePathImage != undefined) {
                ...
                fileDelete.delete().then((imageDelete) => {
                    ...
                    console.log('Se excluiu a imagem')
                }).catch(err => {
                    console.log('Falhou a remoção da imagem, error:', err)
                });
